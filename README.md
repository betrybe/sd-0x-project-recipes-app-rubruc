...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-0x-project-recipes-app-rubruc.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-0x-project-recipes-app-rubruc`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-0x-project-recipes-app-rubruc/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-0x-project-recipes-app-rubruc/pulls) e confira que o seu _Pull Request_ está criado
